  ...
  var SEARCH_INDEX = [
    ...
    },
    {
      ...
      description: {
        ...
        ja: '端末内データ、権限、スマートアシスト、音声メッセージ、Daily、タロット、診断、バックアップの扱いを確認できます。',
      ...
      text: {
        ...
        ja: 'プライバシー 端末内データ Apple Music 写真 スマートアシスト Apple Intelligence 音声メッセージ 音声パッケージ Daily タロット 診断 バックアップ localStorage',
    ...
    },
    {
      ...
      description: {
        ...
        ja: 'サブスクリプション、音声拡張購入、購入復元、権限、Daily、タロット、読み込み・書き出し、データ削除、連絡先。',
      ...
      text: {
        ...
        ja: 'サポート FAQ サブスクリプション 音声拡張 購入復元 権限 スマートアシスト Apple Intelligence 音声メッセージ Daily タロット 読み込み 書き出し データ削除 連絡',
